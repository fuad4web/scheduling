...
?>
<script>alert("Note: The Firstname is used as the Username while the Lastname is used as the Password");</script>
<!DOCTYPE html>
<html>
  <head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <title>Lecturer | <?php include('../dist/includes/title.php');?></title>
								...
								<select class="form-control select2" name="designation">
								  <?php 
									$query2=mysqli_query($con,"select * from designation order by designation_name")or die(mysqli_error($con));
									  while($row=mysqli_fetch_array($query2)){
								  ?>
                  <option value="">Optional for Student</option>
