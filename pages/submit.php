...
if($_POST)
{
	...
	foreach ($m as $daym){
		...
		natural join member natural join time where member_id='$member' and schedule.time_id='$daym' and day='m'")or die(mysqli_error($con));
			...
			<table width='100%' border='2'>
				<tr>
					<td style='padding: 5px;'>monday</td>
					<td style='padding: 5px;'>$time1</td> 
					<td style='padding: 5px;'>$member1</td>
		...
		natural join member natural join time where room='$room' and schedule.time_id='$daym' and day='m'")or die(mysqli_error($con));
			...
			<table width='100%' border='2'>
				<tr style='padding: 20px;'>
					<td style='padding: 5px;'>monday</td>
					<td style='padding: 5px;'>$timer</td> 
					<td style='padding: 5px;'>Room $roomr</td>
					<td class='text-danger'><b>Not Available</b></td>					
				</tr>
				</span>
			</table>";
		...
		natural join member natural join time where cys='$cys' and schedule.time_id='$daym' and day='m'")or die(mysqli_error($con));
			...
			<table width='100%' border='2'>
				<tr style='padding: 20px;'>
					<td style='padding: 5px;'>monday</td>
					<td style='padding: 5px;'>$timec</td> 
					<td style='padding: 5px;'>$cysc</td>
					<td class='text-danger'><b>Not Available</b>	</td>					
				</tr>
			</table></span>";	
		...
		{
			// $rank_id = $_POST['mycys'];
			mysqli_query($con,"INSERT INTO schedule(time_id,day,member_id,subject_code,cys,room,remarks,settings_id,encoded_by,rank_id) 
				VALUES('$daym','m','$member','$subject','$cys','$room','$remarks','$set_id','$program','$rank_id')")or die(mysqli_error());
				
			echo "<span class='text-success'>
			<table width='100%' border='2'>
				<tr style='padding: 20px;'>
					<td style='padding: 5px;'>monday</td>
					<td style='padding: 5px;'>$timet</td> 
	...
	foreach ($w as $daym){
		...
		natural join member natural join time where member_id='$member' and schedule.time_id='$daym' and day='w'")or die(mysqli_error($con));
			...
			<table width='100%' border='2'>
				<tr>
					<td style='padding: 5px;'>wendnesday</td>
					<td style='padding: 5px;'>$time1</td> 
					<td style='padding: 5px;'>$member1</td>
					<td class='text-danger'><b>Not Available</b></td>					
				</tr>
		...
		natural join member natural join time where room='$room' and schedule.time_id='$daym' and day='w'")or die(mysqli_error($con));
			...
			<table width='100%' border='2'>
				<tr style='padding: 20px;'>
					<td style='padding: 5px;'>wednesday</td>
					<td style='padding: 5px;'>$timer</td> 
					<td style='padding: 5px;'>Room $roomr</td>
					<td class='text-danger'><b>Not Available</b></td>					
				</tr>
		...
		if (($count_t==0) and ($count_r==0) and ($count_c==0))
		{
			...
			// $rank_id = $_POST['mycys'];
			mysqli_query($con,"INSERT INTO schedule(time_id,day,member_id,subject_code,cys,room,remarks,settings_id,encoded_by,rank_id) 
				VALUES('$daym','w','$member','$subject','$cys','$room','$remarks','$set_id','$program','$rank_id')")or die(mysqli_error());
	...
	foreach ($f as $daym){
		...
		natural join member natural join time where member_id='$member' and schedule.time_id='$daym' and day='f'")or die(mysqli_error($con));
			...
			<table width='100%' border='2'>
				<tr>
					<td style='padding: 5px;'>friday</td>
					<td style='padding: 5px;'>$time1</td> 
					<td style='padding: 5px;'>$member1</td>
					<td class='text-danger'><b>Not Available</b></td>					
				</tr>
		...
		if (($count_t==0) and ($count_r==0) and ($count_c==0))
		{
			// $rank_id = $_POST['mycys'];
			mysqli_query($con,"INSERT INTO schedule(time_id,day,member_id,subject_code,cys,room,remarks,settings_id,encoded_by,rank_id) 
				VALUES('$daym','f','$member','$subject','$cys','$room','$remarks','$set_id','$program','$rank_id')")or die(mysqli_error());
	...
	foreach ($t as $daym){
		...
		natural join member natural join time where member_id='$member' and schedule.time_id='$daym' and day='t'")or die(mysqli_error($con));
			...
			<table width='100%' border='2'>
				<tr>
					<td style='padding: 5px;'>tuesday</td>
					<td style='padding: 5px;'>$time1</td> 
					<td style='padding: 5px;'>$member1</td>
					<td class='text-danger'><b>Not Available</b></td>					
				</tr>
		...
		if (($count_t==0) and ($count_r==0) and ($count_c==0))
		{
			// $rank_id = $_POST['mycys'];
			mysqli_query($con,"INSERT INTO schedule(time_id,day,member_id,subject_code,cys,room,remarks,settings_id,encoded_by,rank_id) 
				VALUES('$daym','t','$member','$subject','$cys','$room','$remarks','$set_id','$program','$rank_id')")or die(mysqli_error($con));
	...
	foreach ($th as $daym){
		...
		natural join member natural join time where member_id='$member' and schedule.time_id='$daym' and day='th'")or die(mysqli_error($con));
			...
			<table width='100%' border='2'>
				<tr>
					<td style='padding: 5px;'>thursday</td>
					<td style='padding: 5px;'>$time1</td> 
					<td style='padding: 5px;'>$member1</td>
					<td class='text-danger'><b>Not Available</b></td>					
				</tr>
		...
		if (($count_t==0) and ($count_r==0) and ($count_c==0))
		{
			// $rank_id = $_POST['mycys'];
			mysqli_query($con,"INSERT INTO schedule(time_id,day,member_id,subject_code,cys,room,remarks,settings_id,encoded_by,rank_id) 
				VALUES('$daym','th','$member','$subject','$cys','$room','$remarks','$set_id','$program','$rank_id')")or die(mysqli_error());
