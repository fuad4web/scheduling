...
<html>
  ...
  <body class="hold-transition skin-yellow layout-top-nav" onload="myFunction()">
    ...
    ?>
                ...
                <td><a id="click" href="class.php?id=<?php echo $id;?>&cys=<?php echo $cys;?>&numb=<?php echo $number;?>">
					 ...
					 <div class="col-md-12">
						  ...
						  <div class="form-group">
							<label for="date">Add Class</label><br>
								<input type="text" class="form-control" name="class" placeholder="Class Name" required><br>
                <input type="text" class="form-control" name="number" placeholder="Number of Students" required><br>
					 ...
					 <div class="col-md-12">
						  ...
						  <div class="form-group">
							<label for="date">Update Class</label><br>
								...
								<input type="text" class="form-control" id="class" name="class" value="<?php echo $_REQUEST['cys'];?>" placeholder="Class Name" required><br>
                <input type="text" class="form-control" id="number" name="numb" value="<?php echo $_REQUEST['numb'];?>" placeholder="Number of Students" required>
						  </div><!-- /.form group -->
					</div>
				  </div>	
