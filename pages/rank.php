...
<html>
  <head>
    ...
    <title>Faculty | <?php include('../dist/includes/title.php');?></title>
				  ...
				  <div class="row">
					 <div class="col-md-12">
						  ...
						  <div class="form-group">
							<label for="date">Add Faculty</label><br>
								<input type="text" class="form-control" name="rank" placeholder="Faculty" required>
					 ...
					 <div class="col-md-12">
						  ...
						  <div class="form-group">
							<label for="date">Update Rank</label><br>
								...
								<input type="text" class="form-control" id="class" name="rank" value="<?php echo $_REQUEST['rank'];?>" placeholder="Faculty" required>
						  </div><!-- /.form group -->
					</div>
				  </div>	
