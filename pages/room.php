...
<html>
  <head>
    ...
    <title>Lecture Room | <?php include('../dist/includes/title.php');?></title>
  ...
  <body class="hold-transition skin-yellow layout-top-nav" onload="myFunction()">
    ...
    <?php
        ...
        $query=mysqli_query($con,"select * from room order by room")or die();
    ...
    ?>
      <tr>
        ...
        <td>
        <a id="click" href="room.php?id=<?php echo $id;?>&room=<?php echo $room;?>&capacity=<?php echo $capacity;?>">
		...
		<div class="col-md-6">
            ...
            <div class="col-md-3">
              <div class="box box-warning">
				  ...
				  <div class="row">
					 <div class="col-md-12">
						  ...
						  <div class="form-group">
							<label for="date">Add Lecture Room</label><br>
								<input type="text" class="form-control" name="room" placeholder="Room" required><br>
				...
				<div class="box-body" id="displayform">
                  <!-- Date range -->
                  <div id="form">
					 ...
					 <div class="col-md-12">
						  ...
						  <div class="form-group">
							<label for="date">Update Room</label><br>
								...
								<input type="text" class="form-control" id="class" name="room" value="<?php echo $_REQUEST['room'];?>" placeholder="Room" required><br>
								<input type="text" class="form-control" id="capacity" name="capacity" value="<?php echo $_REQUEST['capacity'];?>" placeholder="Capacity" required>
						  </div><!-- /.form group -->
					</div>
				  </div>	
