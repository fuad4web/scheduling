...
<table class="table table-bordered table-striped" style="margin-right:-10px">
    ...
    <?php
        ...
        $query=mysqli_query($con,"SELECT b.dept_code, b.dept_name, a.rank, a.rank_id, b.dept_id FROM rank AS a INNER JOIN dept AS b ON a.rank_id = b.rank_id ORDER BY dept_id")or die(mysqli_error());
    ...
    ?>
              ...
              <tr>
                ...
                <td>
                  <a id="click" href="department.php?id=<?php echo $id;?>&code=<?php echo $code;?>&name=<?php echo $name;?>">
