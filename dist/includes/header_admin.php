            ...
            <!-- Navbar Right Menu -->
              <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                  <li>
                    <a href="admin_faculty_home.php" class="" style="font-size:14px"><i class="glyphicon glyphicon-star-empty"></i> My Schedule</a>
                  </li>
                  <!-- Tasks Menu -->
                 <li class="">
                    <!-- Menu Toggle Button -->
                    ...
                    <ul class="dropdown-menu">
                      <li>
                        ...
                        <ul class="menu">
                          ...
                          <li><!-- start notification -->
                            <a href="room.php">
                              <i class="glyphicon glyphicon-scale text-green"></i> Lecture Room
                            </a>
                          </li><!-- end notification -->
						
						  <li><!-- start notification -->
                            <a href="subject.php">
                              <i class="glyphicon glyphicon-user text-green"></i> Course
                            </a>
                          </li><!-- end notification -->
						  
						            <li><!-- start notification -->
                            <a href="teacher.php">
                              <i class="glyphicon glyphicon-user text-green"></i> Add New Member
                            </a>
                          </li><!-- end notification -->
						              <li>
                            <a href="time.php">
                              <i class="glyphicon glyphicon-user text-green"></i> Add Time
                            </a>
                          </li>
                          <!-- end notification -->
                        </ul>
              ...
              <!-- <li>start notification
						  ...
						  <li><!-- start notification -->
                            <a href="rank.php">
                              <i class="glyphicon glyphicon-send text-green"></i> Faculty
                            </a>
                          </li><!-- end notification -->
